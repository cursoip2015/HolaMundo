...
<jsp:include page="../../plantillas/nav.jsp"></jsp:include>
	  ...
	  <div id="encabezado"  >
			...
			<h1><a href="ejemplos/basicos/parrafos.jsp#p1" title="Ir a sección X1">Hola clase!!1</a></h1>
			<h2><a href="<%=request.getRequestURI()%>#p2" title="Ir a sección X2">Hola clase!!2</a></h2>
			<h3><a href="<%=request.getRequestURI()%>#p3" title="Ir a sección X3">Hola clase!!3</a></h3>  
			<h4><a href="<%=request.getRequestURI()%>#p4" title="Ir a sección X4">Hola clase!!4</a></h4>
			<h5><a href="<%=request.getRequestURI()%>#p5" title="Ir a sección X5">Hola clase!!5</a></h5>
			<h6><a href="<%=request.getRequestURI()%>#p6" title="Ir a sección X6">Hola clase!!6</a></h6>
